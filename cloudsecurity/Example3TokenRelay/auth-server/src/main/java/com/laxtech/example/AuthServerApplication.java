...
// next answer is: @EnableResourceServer (is extended from WebSecurityConfigurerAdapter) I believe this makes api secure ie client need to send valid security token.
