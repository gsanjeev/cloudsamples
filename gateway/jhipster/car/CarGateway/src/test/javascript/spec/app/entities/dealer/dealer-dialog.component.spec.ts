...
import { DealerDialogComponent } from '../../../../../../main/webapp/app/entities/dealer/dealer-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Dealer Management Dialog Component', () => {
        let comp: DealerDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(DealerDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'dealerListModification', content: 'OK'});
